...
extension ConfigReader {
    ...
    public func requiredString(forKey key: String) throws -> String {
    ...
    public func requiredStringArray(forKey key: String) throws -> [String] {
    ...
    public func uuid(forKey key: String, default defaultValue: UUID) -> UUID {
    ...
    public func uuidArray(forKey key: String, default defaultValue: [UUID] = []) -> [UUID] {
    ...
    public func requiredUUIDArray(forKey key: String) throws -> [UUID] {
    ...
    public func splitCSV(_ value: String) -> [String] {
        var seen = Set<String>()
        return
            value
