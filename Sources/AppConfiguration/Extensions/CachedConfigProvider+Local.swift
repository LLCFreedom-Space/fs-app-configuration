...
extension CachedConfigProvider {
    ...
    public func loadJWKS(app: Application, jwksFileName: String) -> String? {
    ...
    public func loadVersion(app: Application) -> String? {
        ...
        guard
            let version = yaml.split(separator: "\n")
